...
<section
    class="tw-w-[1370px] tw-flex tw-flex-row tw-items-start tw-justify-end tw-pt-0 tw-px-[46px] tw-pb-7 tw-box-border tw-max-w-full tw-text-left tw-text-29xl tw-text-light-gray-11 tw-font-lato lg:tw-pl-[23px] lg:tw-pr-[23px] lg:tw-box-border">
